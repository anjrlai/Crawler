package com.jvax.crawler.gamer;
import java.util.*;
 ...
 * 
 */
public class GamerCrawler extends Crawler{

    private Document xmlDoc;

    private String test_url              = "https://forum.gamer.com.tw/C.php?bsn=19017&snA=39177&last=1&subbsn=0#down";
    private String test_url_list         = "https://forum.gamer.com.tw/B.php?bsn=19017&subbsn=0";
    private final String WebpageBase     = "https://forum.gamer.com.tw/";
    ...
    private String article_token         = "section";
    ...
    private String postdate_token        = "a.edittime.tippy-post-info";
    ...
    private String subject_token         = "h1.c-post__header__title";
     ...
     */
    private String filterPattern = "https://forum.gamer.com[-a-zA-Z0-9+@#/=~_|.;\\p{Punct}]*";
    ...
    protected void parseArticle(String HTML){
		...
		//####
        //"div.BH-master"
        //"div.BH-lbox.GN-lbox3"
        //"div.BH-lbox GN-lbox6"
...
// 			ArticleContent=(quote.length()==0)?ArticleContent:ArticleContent.replace(quote, "q["+quote+"]");
    ...
    private String chopPostDate(Element article){
        ...
        return article.select(postdate_token).text();
...
// System.out.println(super.getUrl()+"\t"+article.select(subject_token).text());
        return article.select(subject_token).text();
